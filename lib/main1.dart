  ...
  goToListView(mynumber) {
    ...
    Navigator.of(context).push(
      MaterialPageRoute<void> (
        builder: (BuildContext context) => ListViewComponent(view_number: mynumber)
      )
    );
  }
      ...
      body: new Column(
        children: <Widget>[
          ...
          Container(
            child: new FlatButton(
              onPressed: () {
                Navigator.push(context, MaterialPageRoute(builder: (context) => GridViewComponent(
